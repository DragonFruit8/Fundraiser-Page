                ...
                <div className="row flex-lg-row-reverse g-0 align-items-center">
                    <div className="col-lg-6">
                        <div className="lc-block">
                            ...
                            <img className="w-100" src="https://images.unsplash.com/photo-1428550590922-34c77f716ad4?crop=entropy&a;cs=tinysrgb&amp;fit=crop&amp;fm=jpg&amp;ixid=M3wzNzg0fDB8MXxzZWFyY2h8Mnx8YmxhY2slMjBhbmQlMjB3aGl0ZXxlbnwwfDB8fHwxNzAzMDc0MzIzfDA&amp;ixlib=rb-4.0.3&amp;q=80&amp;w=1080&amp;h=768" alt="Photo by Jeremy Ricketts" loading="lazy"/>
                        </div>
                    </div>
                    <div className="col-lg-6">
